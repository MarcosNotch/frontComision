...
export default function Vecinos() {
    ...
    const { data: clients, loading: loadingF, error: errorF, totalRows} = useFetch(`https://rl6ffmie96.execute-api.us-east-1.amazonaws.com/production/api/v1/vecinos?idZona=${idZona}&pageNum=${pagina}${valorFiltroTitular ? `&nombre=${valorFiltroTitular}` : ''}${valorFiltroNroAdherente ?`&nroAdherente=${valorFiltroNroAdherente}` : '' }`, recargarPagina)
